...
function showCouponPopup(title, details, code,howToAvail,termsAndConditions ) {
    document.getElementById("coupon-title").innerText = title;
    document.getElementById("coupon-terms").innerText = details;
    document.getElementById("how-to-avail").innerText = howToAvail || "Information not available.";
    document.getElementById("terms-and-conditions").innerText = termsAndConditions  || "No terms specified.";
